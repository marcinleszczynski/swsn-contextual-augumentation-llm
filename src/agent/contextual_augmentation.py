    ...
    def extract_entities(self, text: str) -> List[str]:
        ...
        agent = Agent(
            ...
            system_prompt=(
                ...
                "4. Do not include determiners (like 'The') unless they are part of "
                "the official name.\n"
            )
        )
    ...
    def expand_entities(
        ...
        agent = Agent(
            ...
            system_prompt=(
                ...
                "**The Golden Rule:** Use the provided text to *identify* who/what "
                "the entity is, but use your internal knowledge to provide their "
                "*full legal/official name*.\n\n"
                "**Instructions:**\n"
                "1. **Analyze Domain:** Determine the topic of the text (e.g., "
                "Physics, Basketball, mythological).\n"
                ...
                "4. **Complete Names:** If a person is mentioned by surname only, "
                "output their full name.\n"
                "   - Example: 'Curie' -> 'Marie Curie' (if context implies her).\n"
                "5. **Strict Output:** If the expanded name is not 100% certain "
                "from context, keep the original."
            )
        )
